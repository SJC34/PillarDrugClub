    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="pt-20 md:pt-28 pb-16 md:pb-24 px-6 md:px-12">
        <div className="max-w-3xl">
          <p className="text-xs font-bold tracking-[0.3em] uppercase text-secondary mb-6 text-center" data-testid="text-hero-badge">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-7xl font-black text-foreground leading-[1.05] mb-6" data-testid="text-hero-headline">
            ...
            At <em className="text-secondary">actual</em> wholesale cost.
          </h1>
      ...
      <section className="py-12 md:py-20 px-6 md:px-12 bg-muted/30">
        <div className="max-w-2xl mx-auto">
          <p className="text-xs font-bold tracking-[0.3em] uppercase text-primary mb-8 text-center" data-testid="text-table-label">
      ...
      <section className="py-16 md:py-24 px-6 md:px-12">
        <div className="max-w-3xl mx-auto">
          <p className="text-xs font-bold tracking-[0.3em] uppercase text-primary mb-4" data-testid="text-problem-label">
            THE REAL PROBLEM
          </p>
      ...
      <section className="py-16 md:py-24 px-6 md:px-12 bg-muted/30">
        <div className="max-w-3xl mx-auto">
          <p className="text-xs font-bold tracking-[0.3em] uppercase text-primary mb-4" data-testid="text-how-label">
            HOW IT WORKS
          </p>
      ...
      <section className="py-16 md:py-24 px-6 md:px-12">
        <div className="max-w-3xl mx-auto">
          <p className="text-xs font-bold tracking-[0.3em] uppercase text-primary mb-4" data-testid="text-numbers-label">
            THE NUMBERS
          </p>
      ...
      <section className="py-16 md:py-24 px-6 md:px-12 bg-muted/30">
        <div className="max-w-3xl mx-auto">
          <p className="text-xs font-bold tracking-[0.3em] uppercase text-primary mb-4" data-testid="text-faq-label">
            QUESTIONS
          </p>

...
- **Membership Pricing** (January 2026): Annual billing model with three tiers:
  - **Foundation (Free)**: $0/year, $30 fulfillment per order, up to 90-day supply. Best for trying Pillar before committing.
  - **Gold – 6 Month**: $59/year, $10 fulfillment per shipment, up to 6-month supply. Most popular option for stable medications.
  - **Gold – 12 Month**: $99/year, $10 fulfillment per shipment, up to 12-month supply. Maximum convenience with zero refills.
